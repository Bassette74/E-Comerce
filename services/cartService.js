...
async function criarCarrinho(userId, items, totalPrice) {
    try {
...
async function buscarCarrinhoPorUsuario(userId) {
    try {
...
async function atualizarCarrinho(userId, items, totalPrice) {
    try {
...
async function removerCarrinho(userId) {
    try {
